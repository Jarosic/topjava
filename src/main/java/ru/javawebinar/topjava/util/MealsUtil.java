...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 9, 0), "Завтрак", 500, SecurityUtil.authUserId()),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 20, 0), "Обед", 1000, SecurityUtil.authUserId()),
    ...
    public static <T extends Comparable<T>> List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, T startTime, T endTime) {
